...
<body class="antialiased dark:bg-gray-900">
    ...
    <div class="min-h-50 bg-dots-darker bg-center bg-gray-100 dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @auth
            <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Área Restrita</a>
            @else
    ...
    @if (!empty($footer))
    <!-- Footer container -->
    <footer style="background-color: rgb(255 200 102); border-radius: 0.125rem; margin-left: 10px; margin-left: 10px;" class="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
